...
CaptionPluginManager::CaptionPluginManager(const CaptionPluginSettings &settings):
        plugin_settings(settings), source_captioner(settings.enabled,settings.source_cap_settings,current_scene_collection_name(),false){}
